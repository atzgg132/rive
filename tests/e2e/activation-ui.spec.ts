...
test.describe("goal-aware activation", () => {
  test("registration pauses at email verification before onboarding", async ({ page }) => {
    ...
    await page.goto("/register?invite=test-invite", { waitUntil: "load" });
    await expect(page.getByRole("dialog")).toBeVisible();
    await expect(page.locator('form[data-testid="register-form"][data-hydrated="true"][data-invite="test-invite"]')).toBeVisible();
