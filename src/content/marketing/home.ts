...
export const homeContent = {
  ...
  bento: [
    ...
    { eyebrow: "TIME", title: "Dates stop hiding in tabs.", body: "Project deadlines and tasks share one calendar, with Google Calendar sync and a private Apple Calendar feed.", metric: "One timeline" },
  ...
  scrolly: {
    ...
    chapters: [
      ...
      },
      {
        ...
        body: "Project milestones and tasks appear on one calendar. Google Calendar sync and a private Apple Calendar feed carry Rive deadlines into the calendar you already check.",
        visual: {
          kind: "calendar",
          props: {
            month: "August 2026",
  ...
  faq: {
    ...
    items: [
      ...
      { question: "Which calendar integrations are live?", answer: "Google Calendar sync and a private Apple Calendar subscription feed are live." },
