export const pricingContent = {
  ...
  title: "Use the whole workspace. Pay nothing during beta.",
  body: "Rive is open to anyone while we prove the operating model. No invitation, no credit card, and no feature maze designed to force an upgrade.",
  price: "₹0",
  cadence: "during open beta",
  plan: "One complete workspace",
  features: [
  ...
  cta: { label: "Start your workspace", href: "/register" },
} as const;
