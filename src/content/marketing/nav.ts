...
export const marketingNav: MarketingNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Blog", href: "/blog", description: "Notes on connected independent work" },
      { label: "Community", href: "/community", description: "Build the operating model with us" },
    ],
  },
];
...
export const marketingRouteMetadata = [
  ...
  { path: "/blog", title: "Rive field notes", description: "Notes on the systems, decisions, and hidden coordination cost behind independent client work.", priority: 0.55 },
  ...
  { path: "/community", title: "Rive community", description: "A working group for independent professionals shaping a more connected way to run client work.", priority: 0.5 },
