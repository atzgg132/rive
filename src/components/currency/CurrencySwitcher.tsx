  ...
  return (
    ...
    >
      ...
      <Select
        ...
        className={`${compact ? "w-20 min-w-20" : "w-40 min-w-40"} h-7 shrink-0 border-0 bg-transparent py-0 pl-1 pr-7 text-xs font-black text-foreground shadow-none focus:ring-0`}
      >
