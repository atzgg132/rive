                ...
                <article key={practice.id} className="rounded-2xl border border-slate-200 p-5 dark:border-slate-700">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <label className="flex flex-col gap-2">
                      ...
                      {reserved && <span className="text-xs font-semibold text-red-600 dark:text-red-400">“{derivedSlug}” is reserved. Pick another address.</span>}
                      {duplicate && <span className="text-xs font-semibold text-red-600 dark:text-red-400">Another practice already uses this address.</span>}
                      {unusableSlug && (
