  ...
  return (
    <section className="relative overflow-hidden bg-background py-32 dark:bg-background">
      ...
      <div className="relative mx-auto flex max-w-3xl flex-col items-center gap-6 px-8 text-center">
        ...
        <h2 className="max-w-4xl font-black leading-[0.98] tracking-[-0.045em] text-slate-900 dark:text-white" style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2.75rem, 7vw, 5.75rem)" }}>Stop juggling tools.<span className="mt-2 block text-blue-700 dark:text-blue-400">Run everything together.</span></h2>
        <p className="max-w-xl text-lg font-medium leading-relaxed text-slate-600 dark:text-slate-300">Bring client work, delivery, finances, planning, and your public presence into one connected workspace.</p>
