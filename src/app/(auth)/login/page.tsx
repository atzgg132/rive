    ...
    <div className="flex min-h-screen items-center justify-center bg-background dark:bg-background px-4 py-12 sm:px-6 lg:px-8 relative overflow-hidden transition-colors">
      ...
      <div className="z-10 w-full max-w-md">
        <div className="mb-6 flex flex-col items-center sm:mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground dark:text-slate-100">Your context is still here.</h1>
          <p className="mt-1.5 text-sm text-muted-foreground dark:text-slate-400">Return to the client, the work, the money, and what needs your attention next.</p>
        </div>
        ...
        <div className="glass rounded-2xl border border-border bg-white/80 p-5 shadow-[0_8px_30px_rgb(12,30,54,0.04)] dark:border-slate-800 dark:bg-slate-900/80 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="login-email" className="text-xs font-bold text-foreground dark:text-slate-300 tracking-wide">Email address</label>
