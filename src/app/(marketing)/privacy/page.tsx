          ...
          <div className="min-w-0 max-w-2xl flex-1 overflow-x-clip">
            <div>
              ...
              <Section id="use" title="3. How we use your information">
                ...
                <p><strong>Service emails.</strong> We send a small number of account-related emails. Some are required to run your account and cannot be turned off: email verification, password reset, and security notices when your password changes or two-factor authentication is turned on, turned off, or given new recovery codes. Others are optional: a login-alert notice each time your account is signed in to, and, only if you turn it on, a weekly business summary sent Monday mornings in your local time. None of these are marketing email. The optional ones can be turned off from Settings → Notifications; the weekly summary can also be turned off from the unsubscribe link in the email itself.</p>
              </Section>
