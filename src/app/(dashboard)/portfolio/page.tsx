    ...
    <div className="portfolio-editor-panels workspace-page gap-5">
      <div className="sticky top-0 z-20 border-b border-border bg-background/95 py-4 backdrop-blur">
        <PageHeader
          ...
          description="Shape your public presence, review the complete experience, and publish when it is ready."
          actions={<>
            {savedPublicUrl && <a href={savedPublicUrl} target="_blank" rel="noreferrer" className="inline-flex h-10 items-center gap-2 rounded-xl border border-border bg-card px-4 text-sm font-semibold text-foreground shadow-sm hover:bg-accent"><ExternalLink className="h-4 w-4" /> Open public</a>}
