...
import { Check, Copy, Eye, ExternalLink, Globe2, LayoutTemplate, Plus, Save, Trash2, BarChart3, Upload } from "lucide-react";
import { toast } from "sonner";
import PortfolioRenderer from "@/components/portfolio/PortfolioRenderer";
import { DEFAULT_PORTFOLIO_CONTENT, DEFAULT_PORTFOLIO_THEME, mergePortfolioContent, normalizeSlug, PORTFOLIO_TEMPLATES, type PortfolioContent, type PortfolioTheme } from "@/utils/portfolio";
...
export default function PortfolioDashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-6 pb-12">
      ...
      {tab === "preview" && <div className="overflow-hidden rounded-2xl border border-[#E2EAF4] bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900"><PortfolioRenderer content={content} theme={theme} templateKey={templateKey} preview /></div>}
