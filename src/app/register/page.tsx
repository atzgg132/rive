    ...
    <div className="flex min-h-screen items-center justify-center bg-[#F5F8FC] px-4 py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-[#0C1E36]">create your workspace</h2>
          <p className="mt-1.5 text-sm text-[#4A5E78]">start your freelance operating system in seconds.</p>
        </div>
        ...
        <div className="glass p-8 bg-white/80 border border-[#E2EAF4] shadow-[0_8px_30px_rgb(12,30,54,0.04)] rounded-2xl">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-bold text-[#0C1E36] tracking-wide">your name</label>
              <div className="relative">
                <User className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-[#4A5E78]" />
                <input
                  type="text"
                  value={name}
          ...
          <div className="mt-6 pt-5 border-t border-[#E2EAF4] text-center">
            <p className="text-xs text-[#4A5E78]">
              ...
              <Link href="/login" className="text-[#1D4ED8] hover:underline font-bold">
                sign in instead
              </Link>
            </p>
          </div>
