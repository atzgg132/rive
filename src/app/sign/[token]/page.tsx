...
/**
 * Compatibility entry point for bearer acceptance links. It forwards to the
 ...
 * /sign page — the raw token never stays in the address bar.
 *
 ...
 */
export default async function ContractSignTokenPage({
  params,
  searchParams,
}: {
  ...
  const href = `/api/public/contracts/sign/${encodeURIComponent(token)}/session${query}`;
  return (
