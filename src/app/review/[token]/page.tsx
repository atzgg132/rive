...
export default function ContractReviewPage() {
  ...
  if (loading) return <Centered><Loader2 className="h-6 w-6 animate-spin text-primary" /><span>Loading contract…</span></Centered>;
